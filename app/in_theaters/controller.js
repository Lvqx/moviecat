(function(angular) {
		...
		var data = [{
				...
				"collect_count": 567141,
				"original_title": "WALL\u00b7E",
				"subtype": "movie",
				"directors": [{
					"alt": "https:\/\/movie.douban.com\/celebrity\/1036450\/",
					"avatars": {
						"small": "http://img3.doubanio.com\/img\/celebrity\/small\/1467359656.96.jpg",
				...
				"casts": [{
					...
					"avatars": {
						"small": "http://img7.doubanio.com\/img\/celebrity\/small\/45035.jpg",
						"large": "http://img7.doubanio.com\/img\/celebrity\/large\/45035.jpg",
						"medium": "http://img7.doubanio.com\/img\/celebrity\/medium\/45035.jpg"
					},
					"name": "\u9a6c\u9f99\u00b7\u767d\u5170\u5ea6",
					"id": "1041025"
				}, {
	...
	module.controller('InTheaterController', ['$scope', function($scope) {
		$scope.subjects = data;
	}]);
})(angular)
